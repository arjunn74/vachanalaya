...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vachanalaya — A digital library of Hindu texts" },
      { name: "description", content: "Read the 108 Upanishads in English with a calm, focused reader designed for study and reflection." },
      { name: "author", content: "Vachanalaya" },
      { property: "og:title", content: "Vachanalaya — A digital library of Hindu texts" },
    ...
    links: [
      ...
      {
        rel: "icon",
        href: "/public/data/Screenshot 2026-06-24 165537.ico",
      },
    ],
  }),
